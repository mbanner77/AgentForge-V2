...
// Explizite Farb-Mapping für Tailwind (dynamische Klassen funktionieren nicht)
...
const getAgentInfo = (agentId: string) => {
  ...
  if (marketplaceAgent) {
    return {
      ...
      // Verwende explizites Mapping für Tailwind-Kompatibilität
      bgColor: colorMapping[marketplaceAgent.color] || "bg-gray-500",
    }
  }
  return {
    icon: Brain,
