...
export const mcpServers: MCPServer[] = [
  ...
  // === SAP MCP SERVERS ===
  {
    id: "cap",
    name: "SAP CAP",
    description: "SAP Cloud Application Programming Model - CDS Modeling, Services, Handlers.",
    category: "development",
    icon: "Layers",
    color: "text-blue-600",
    author: "SAP",
    repository: "https://github.com/cap-js/mcp-server",
    npmPackage: "@cap-js/mcp-server",
    capabilities: ["search_model", "generate_service", "generate_entity", "add_handler", "cds_compile", "cds_docs"],
    isInstalled: false,
    isOfficial: true,
    stars: 850,
    version: "1.0.0",
    configSchema: [
      { name: "projectPath", type: "string", label: "CAP Projekt-Pfad", description: "Pfad zum CAP-Projekt", required: true, default: "./" },
    ],
  },
  {
    id: "ui5",
    name: "SAP UI5",
    description: "SAPUI5 Framework - Views, Controllers, Components, Models.",
    category: "development",
    icon: "Layout",
    color: "text-orange-500",
    author: "SAP",
    ...
    capabilities: ["search_api", "generate_view", "generate_controller", "add_binding", "ui5_docs"],
    isInstalled: false,
    isOfficial: true,
    stars: 620,
    version: "1.0.0",
    configSchema: [
      { name: "projectPath", type: "string", label: "UI5 Projekt-Pfad", description: "Pfad zum UI5-Projekt", required: true, default: "./" },
    ],
  },
  {
    id: "fiori",
    name: "SAP Fiori",
    description: "SAP Fiori Elements - List Report, Object Page, OData Annotations.",
    category: "development",
    icon: "Smartphone",
    color: "text-teal-500",
    author: "SAP",
    repository: "https://www.npmjs.com/package/@sap-ux/fiori-mcp-server",
    npmPackage: "@sap-ux/fiori-mcp-server",
    capabilities: ["generate_fiori_app", "add_annotation", "search_fiori_docs", "configure_odata", "add_extension"],
    isInstalled: false,
    isOfficial: true,
    stars: 480,
    version: "1.0.0",
    configSchema: [
      { name: "projectPath", type: "string", label: "Fiori Projekt-Pfad", description: "Pfad zum Fiori-Projekt", required: true, default: "./" },
      { name: "odataService", type: "string", label: "OData Service URL", description: "URL des OData Services", required: false },
    ],
  },
  {
    id: "mdk",
    name: "SAP MDK",
    description: "SAP Mobile Development Kit - Mobile Apps, Offline Sync, Actions.",
    category: "development",
    icon: "Tablet",
    color: "text-purple-500",
    author: "SAP",
    repository: "https://github.com/SAP/mdk-mcp-server",
    npmPackage: "@sap/mdk-mcp-server",
    capabilities: ["mdk_gen_project", "mdk_gen_entity", "mdk_gen_action", "mdk_build", "mdk_docs"],
    isInstalled: false,
    isOfficial: true,
    stars: 320,
    version: "1.0.0",
    configSchema: [
      { name: "projectPath", type: "string", label: "MDK Projekt-Pfad", description: "Pfad zum MDK-Projekt", required: true, default: "./" },
    ],
  },
]
